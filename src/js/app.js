export default class Cart {
  ...
  init() {
    ...
    this.saveBtn.addEventListener('click', (e) => {
      ...
      if (this.priceTooltip.classList.contains('if_flex')) {
        this.priceTooltip.classList.remove('if_flex');
        this.priceTooltip.classList.add('if_none');
      }
      if (this.nameTooltip.classList.contains('if_flex')) {
        this.nameTooltip.classList.remove('if_flex');
        this.nameTooltip.classList.add('if_none');
      }
      ...
      if (this.nameInput.value === '') {
        if (this.nameTooltip.classList.contains('if_none')) {
          this.nameTooltip.classList.remove('if_none');
          this.nameTooltip.classList.add('if_flex');
        }
        ...
        if (this.priceTooltip.classList.contains('if_none')) {
          this.priceTooltip.classList.remove('if_none');
          this.priceTooltip.classList.add('if_flex');
        }
    ...
    this.saveBtnRedact.addEventListener('click', (e) => {
      ...
      if (this.priceRedactTooltip.classList.contains('if_flex')) {
        this.priceRedactTooltip.classList.remove('if_flex');
        this.priceRedactTooltip.classList.add('if_none');
      }
      if (this.nameRedactTooltip.classList.contains('if_flex')) {
        this.nameRedactTooltip.classList.remove('if_flex');
        this.nameRedactTooltip.classList.add('if_none');
      }
      ...
      if (this.nameRedact.value === '') {
        if (this.nameRedactTooltip.classList.contains('if_none')) {
          this.nameRedactTooltip.classList.remove('if_none');
          this.nameRedactTooltip.classList.add('if_flex');
        }
        ...
        if (this.priceRedactTooltip.classList.contains('if_none')) {
          this.priceRedactTooltip.classList.remove('if_none');
          this.priceRedactTooltip.classList.add('if_flex');
        }
  ...
  openForm(form) {
    form.classList.toggle('if_none');
    form.classList.toggle('if_flex');
  }
